...
public class ItemRegistry
{
	...
	public static void registerEnchantems()
	{
		...
		if (Enchantment.getEnchantmentByID(soulID) != null)
		{
			...
			SoulShard.soulLog
					.warn("The Soul Stealer enchantment is already registered, a new id is set ! (NEW ID: " + soulID
							+ ").");
		}

		soulStealer = new SoulStealer(Enchantment.Rarity.RARE, EnumEnchantmentType.WEAPON,
				new EntityEquipmentSlot[] { EntityEquipmentSlot.CHEST, EntityEquipmentSlot.MAINHAND });

		Enchantment.enchantmentRegistry
				.register(soulID, new ResourceLocation(Reference.MODID + ".soul_stealer"), soulStealer);
	}
