...
public class SoulStealer extends Enchantment
{
	...
	public SoulStealer(Rarity rarity, EnumEnchantmentType enumEnchantmentType,
			EntityEquipmentSlot[] entityEquipmentSlots)
	{
		super(rarity, enumEnchantmentType, entityEquipmentSlots);
		setName("soul_shard.soul_stealer");
	}

	@Override public int getMinEnchantability(int i)
	{
		return (i - 1) * 11;
	}

	@Override public int getMaxEnchantability(int i)
	{
